...
--
-- Name: rank rank_designation_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rank
    ADD CONSTRAINT rank_designation_key UNIQUE (designation);
...
--
-- Name: event event_comment_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event
    ADD CONSTRAINT event_comment_fkey FOREIGN KEY (comment) REFERENCES public.comment(id) ON UPDATE CASCADE ON DELETE CASCADE;
